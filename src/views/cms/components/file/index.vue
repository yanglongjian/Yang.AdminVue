      ...
      <a-space v-if="windowWidth > 715">
        ...
        <a-button-group>
          ...
          <a-tooltip content="视图" position="bottom">
            <a-button>
              <template #icon>
                <a-icon-apps v-if="viewMode === 'grid'" />
                <a-icon-list v-else />
              </template>
            </a-button>
          </a-tooltip>
...
import { fileTypeList,imageTypeList } from "./constants"

// import "viewerjs/dist/viewer.css"
import FileNavPath from "./file-main/file-nav-path.vue"
import FileGridComp from "./file-main/file-grid.vue"
import FileListComp from "./file-main/file-list.vue"
//import ThePreviewVideo from "./file-main/the-preview-video.vue"
//import ThePreviewAudio from "./file-main/the-preview-audio.vue"

import TheFileRename from "./the-file-rename/index"
import TheFileMove from "./the-file-move/index"
