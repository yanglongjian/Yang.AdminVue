<template>
  <div>
      ...
      >
        ...
        <template #buttons>
          <a-button
            type="primary"
            @click="handleCreate"
            v-permission="['Root.CMS.Bnaner.Create']"
          >
            <template #icon>
              <icon-plus />
            </template>
          ...
          >
            <a-button
              ...
              v-permission="['Root.CMS.Bnaner.Delete']"
            >
              <template #icon>
                <icon-delete />
              </template>
        ...
        <template #operations="{ record }">
          <a-button
            v-permission="['Root.CMS.Bnaner.Update']"
            size="small"
    ...
    >
      <y-form :labelCol="'130px'" ref="editFormRef" :schemas="editSchemas" :rules="editRules">
...
const editRules = ref<any>({
  ...
  name: [{ required: true, message: "请输入Banner名称" }],
